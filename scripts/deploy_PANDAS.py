...
MYTOKENS = {
    0: "0x0000000000000000000000000000000000000000",    # ETHEREUM Holesky      
...
VERIFY = {
    ...
    0: True,           # ETHEREUM Holesky        
    1: True,           # BNB Chain             (False)
    3: False,          # AVALANCHE Fuji --> changed API        
    5: True,           # POLYGON MUMBAI        
    6: False,          # CRONOS                
    7: True,           # FANTOM                
    8: False,          # CELO ALFAJORES        
    100: False         # Ganache BROWNIE
...
PANTOS_HUBS = {
    0: "0x5e447968d4a177fE7bFB8877cA12aE20Bd60dD85",         # ETHEREUM Holesky
    ...
    for blockchain in Blockchain:
        ...
        if MYNETWORKS.get(blockchain.value)==None or MYNETWORKS.get(blockchain.value)=='':
            ...
            if brownie.network.is_connected()==False:
                ...
                myToken = PANDASTOKEN.deploy(NAME ,SYMBOL, DECIMALS, INITIAL_SUPPLY, transaction_parameters, publish_source=VERIFY[blockchain.value])    # <- publish_source = Verify Contract
